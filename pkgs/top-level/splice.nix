...
let
  ...
  spliceReal =
    ...
    let
      ...
      dontMashWhenSplicingParent = dontMashWhenSplicing || inputs.hostTarget.__dontMashWhenSplicing or false;
      dontMashWhenSplicingChildren = dontMashWhenSplicingParent || inputs.hostTarget.__dontMashWhenSplicingChildren or false;
      mash = if dontMashWhenSplicingParent then inputs.hostTarget else mashReal;
      mashReal =
        # Other pkgs sets
        inputs.buildBuild
        // inputs.buildTarget
